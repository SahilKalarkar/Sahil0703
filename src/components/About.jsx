...
import stackImage from '../assets/about/sahil-avatar.png';
...
const ReactIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
      <g stroke="#00d8ff" strokeWidth="4.5" fill="none">
        <ellipse cx="64" cy="64" rx="18" ry="50" transform="rotate(30 64 64)" />
        <ellipse cx="64" cy="64" rx="18" ry="50" transform="rotate(90 64 64)" />
        <ellipse cx="64" cy="64" rx="18" ry="50" transform="rotate(150 64 64)" />
        <circle cx="64" cy="64" r="8" fill="#00d8ff" stroke="none" />
      </g>
    </svg>
...
const ViteIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    >
      <defs>
        <linearGradient id="paint0_linear" x1="6.33" y1="32.99" x2="235.11" y2="344.47" gradientUnits="userSpaceOnUse">
          <stop stopColor="#41D1FF" />
          <stop offset="1" stopColor="#BD34FE" />
        </linearGradient>

        <linearGradient id="paint1_linear" x1="194.65" y1="8.82" x2="236.08" y2="292.99" gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        d="M255.153 37.938L134.897 252.43a8.64 8.64 0 0 1-15.062.002L.846 37.938c-1.96-3.494 1.028-7.7 4.963-6.987l120.5 21.62a8.64 8.64 0 0 0 3.06 0l120.82-21.63c3.94-.706 6.925 3.5 4.964 6.997Z"
      />

      <path
        fill="url(#paint1_linear)"
        d="M185.432.063L96.44 17.505a4.32 4.32 0 0 0-3.486 3.59L87.48 57.89a4.32 4.32 0 0 0 5.183 4.86l24.772-5.63a4.32 4.32 0 0 1 5.187 5.12l-7.36 36.06a4.32 4.32 0 0 0 5.292 5.02l15.3-4.33a4.32 4.32 0 0 1 5.48 5.42l-11.69 56.28c-.73 3.52 3.95 5.44 5.88 2.42l1.29-2.03 72.54-144.78c1.22-2.43-.88-5.19-3.54-4.67l-25.51 4.92a4.32 4.32 0 0 1-4.98-5.38l16.64-57.57A4.32 4.32 0 0 0 185.432.063Z"
      />
    </svg>
...
const MernIcon = () => (
  <div className="flex flex-col items-center gap-2">
    <svg className="w-16 h-16 md:w-20 md:h-20" viewBox="0 0 128 128">
      ...
      {/* React Atom */}
      <g stroke="#00D8FF" strokeWidth="3.8" fill="none">
        <ellipse cx="64" cy="64" rx="18" ry="42" transform="rotate(30 64 64)" />
        <ellipse cx="64" cy="64" rx="18" ry="42" transform="rotate(90 64 64)" />
        <ellipse cx="64" cy="64" rx="18" ry="42" transform="rotate(150 64 64)" />
        <circle cx="64" cy="64" r="6" fill="#00D8FF" stroke="none" />
      </g>
      ...
      <g transform="translate(18 76)">
        <path
          fill="#47A248"
          d="M10 0c5 8 5 18 0 28-5-10-5-20 0-28zm0 7c3 5 3 12 0 18-3-6-3-13 0-18z"
        />
      </g>
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-70 rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-3/4 overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img
                  src={stackImage}
                  alt="Sahil Kalarkar — Full Stack & MERN Developer"
