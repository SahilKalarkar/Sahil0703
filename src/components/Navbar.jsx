...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:sahilkalarkar@gmail.com?subject=Hiring Inquiry – Portfolio&body=Hello Sahil Kalarkar,%0D%0A%0D%0AI came across your portfolio and would like to discuss an opportunity with you.%0D%0A%0D%0ALooking forward to hearing from you.%0D%0ABest Regards,`;

  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isOpen
        ? "bg-[#ff2a2a] shadow-xl py-4"
        : isScrolled
          ? "bg-[#0f172a]/40 backdrop-blur-md shadow-lg py-4"
          : "bg-transparent py-6"
        }`}
    >
