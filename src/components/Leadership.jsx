        ...
        {isEven && (
          ...
          >
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:border-red-500/30 hover:shadow-[0_15px_35px_rgba(255,42,42,0.1)] transition-all duration-500">
              ...
              <p className="text-red-400 text-xs font-bold font-mono uppercase mb-4">
                {item.role}
              </p>
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-20 text-center">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg mx-auto leading-relaxed">
            Coordinating events, leading team operations.
            {/* , and participating in tech summits. */}
          </p>
        </div>
        ...
        <div className="relative w-full">
          {/* Center Line */}
          <div className="absolute left-4 md:left-1/2 -translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-[#ff2a2a] via-red-500/50 to-white/10" />
